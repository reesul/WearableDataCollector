...
public class Notifications {
    ...
    public static Notification getServiceRunningNotification(Context context) {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID_SERVICE_RUNNIGN, "Datacollector service", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public static Notification getReminderNotification(Context context) {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID_REMINDERS, "Datacollector reminders", NotificationManager.IMPORTANCE_DEFAULT);
